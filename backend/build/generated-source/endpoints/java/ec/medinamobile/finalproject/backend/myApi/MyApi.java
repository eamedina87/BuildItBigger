 ...
 * on 2017-07-28 at 21:52:14 UTC 
 * Modify at your own risk.
 */

package ec.medinamobile.finalproject.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetJoke extends MyApiRequest<ec.medinamobile.finalproject.backend.myApi.model.MyJoke> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, ec.medinamobile.finalproject.backend.myApi.model.MyJoke.class);
    }
  ...
  public class SayHi extends MyApiRequest<ec.medinamobile.finalproject.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, ec.medinamobile.finalproject.backend.myApi.model.MyBean.class);
